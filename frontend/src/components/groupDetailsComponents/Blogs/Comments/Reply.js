  ...
  return (
    <div className='w-3/4 ml-12 m-6 border'>
      <article class="my-6 ml-6 text-base bg-white rounded-lg dark:bg-gray-900">
                        ...
                        <p class="text-gray-500 dark:text-gray-400">worth time reading. Thank you! But tools are just the
                    instruments for the UX designers. The knowledge of the design tools are as important as the</p>
