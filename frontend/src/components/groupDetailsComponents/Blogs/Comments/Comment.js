...
const Comment = ({ comment, blog }) => {
  ...
  return (
    <div className="w-3/4 ml-6 m-6 border">
      ...
      <Collapse
        className="border w-3/4 mt-3 rounded m-5"
        in={expanded}
        timeout="auto"
        unmountOnExit
      >
        <div className="flex p-2">
          <input
            ...
            id="first_name"
            value={content}
            className="bg-gray-50 mr-2 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-900 block w-3/4 p-2.5"
